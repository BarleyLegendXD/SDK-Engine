...
class GObj:
    ...
    def make_player(self, speed=200):
        def move(dt):
...
class UIElement:
    ...
    def set_gradient(self, c1, c2): self.gradient = (c1, c2); return self
    ...
    def fade_in(self, duration=1.0):
        self.alpha = 0
        return self.anim("alpha", 255, duration)
...
class UIButton(UIElement):
    ...
    def update(self, dt, inp):
        ...
        if is_hover and inp.mouse_down(0) and self.action:
            self.action()
...
class SDKEngine:
    def __init__(self):
        ...
        self.log("Booting SDK-Engine v1.2.4...", (150, 255, 255))
        self.setup_env()
